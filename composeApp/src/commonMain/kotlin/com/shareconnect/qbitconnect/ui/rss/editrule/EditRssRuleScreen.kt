...
import qbitconnect.composeapp.generated.resources.rss_rule_action_save
import qbitconnect.composeapp.generated.resources.rss_rule_add_paused
import qbitconnect.composeapp.generated.resources.rss_rule_add_paused_always
import qbitconnect.composeapp.generated.resources.rss_rule_add_paused_never
import qbitconnect.composeapp.generated.resources.rss_rule_apply_rule_to_feeds
import qbitconnect.composeapp.generated.resources.rss_rule_category
import qbitconnect.composeapp.generated.resources.rss_rule_enabled
import qbitconnect.composeapp.generated.resources.rss_rule_episode_filter
import qbitconnect.composeapp.generated.resources.rss_rule_ignore_subsequent_matches_for
import qbitconnect.composeapp.generated.resources.rss_rule_must_contain
import qbitconnect.composeapp.generated.resources.rss_rule_must_not_contain
import qbitconnect.composeapp.generated.resources.rss_rule_no_feed_found
import qbitconnect.composeapp.generated.resources.rss_rule_not_found
import qbitconnect.composeapp.generated.resources.rss_rule_save_to
import qbitconnect.composeapp.generated.resources.rss_rule_save_to_a_different_directory
import qbitconnect.composeapp.generated.resources.rss_rule_saved_successfully
import qbitconnect.composeapp.generated.resources.rss_rule_torrent_content_layout
import qbitconnect.composeapp.generated.resources.rss_rule_use_global_settings
import qbitconnect.composeapp.generated.resources.rss_rule_use_regular_expressions
import qbitconnect.composeapp.generated.resources.rss_rule_use_smart_episode_filter
    ...
    EventEffect(viewModel.eventFlow) { event ->
        when (event) {
            ...
            EditRssRuleViewModel.Event.RuleUpdated -> {
                snackbarHostState.currentSnackbarData?.dismiss()
                launch {
                    snackbarHostState.showSnackbar(getString(Res.string.rss_rule_saved_successfully))
                }
            }
            EditRssRuleViewModel.Event.RuleNotFound -> {
                snackbarHostState.currentSnackbarData?.dismiss()
                launch {
                    snackbarHostState.showSnackbar(getString(Res.string.rss_rule_not_found))
                }
            }
        }
    }
            ...
            TopAppBar(
                ...
                actions = {
                    val actionMenuItems = listOf(
                        ActionMenuItem(
                            title = stringResource(Res.string.rss_rule_action_save),
            ...
            Column(
                ...
                Column(
                    ...
                    CheckboxWithLabel(
                        ...
                        label = stringResource(Res.string.rss_rule_enabled),
                        enabled = isFetched,
                    )
                    ...
                    CheckboxWithLabel(
                        ...
                        label = stringResource(Res.string.rss_rule_use_regular_expressions),
                        enabled = isFetched,
                    )
                    ...
                    OutlinedTextField(
                        ...
                        label = {
                            Text(
                                text = stringResource(Res.string.rss_rule_must_contain),
                                maxLines = 1,
                                overflow = TextOverflow.Ellipsis,
                            )
                        },
                    ...
                    OutlinedTextField(
                        ...
                        label = {
                            Text(
                                text = stringResource(Res.string.rss_rule_must_not_contain),
                                maxLines = 1,
                                overflow = TextOverflow.Ellipsis,
                            )
                        },
                    ...
                    OutlinedTextField(
                        ...
                        label = {
                            Text(
                                text = stringResource(Res.string.rss_rule_episode_filter),
                                maxLines = 1,
                                overflow = TextOverflow.Ellipsis,
                            )
                        },
                    ...
                    CheckboxWithLabel(
                        ...
                        label = stringResource(Res.string.rss_rule_use_smart_episode_filter),
                        enabled = isFetched,
                    )
                }
                ...
                Column(
                    ...
                    ExposedDropdownMenuBox(
                        ...
                        OutlinedTextField(
                            label = {
                                Text(
                                    text = stringResource(Res.string.rss_rule_category),
                                    maxLines = 1,
                                    overflow = TextOverflow.Ellipsis,
                                )
                            },
                    ...
                    CheckboxWithLabel(
                        ...
                        label = stringResource(Res.string.rss_rule_save_to_a_different_directory),
                        enabled = isFetched,
                    )
                    ...
                    OutlinedTextField(
                        ...
                        label = {
                            Text(
                                text = stringResource(Res.string.rss_rule_save_to),
                                maxLines = 1,
                                overflow = TextOverflow.Ellipsis,
                            )
                        },
                    ...
                    OutlinedTextField(
                        ...
                        label = {
                            Text(
                                text = stringResource(Res.string.rss_rule_ignore_subsequent_matches_for),
                                maxLines = 1,
                                overflow = TextOverflow.Ellipsis,
                            )
                        },
                    ...
                    ExposedDropdownMenuBox(
                        ...
                        OutlinedTextField(
                            label = {
                                Text(
                                    text = stringResource(Res.string.rss_rule_add_paused),
                                    maxLines = 1,
                                    overflow = TextOverflow.Ellipsis,
                                )
                            },
                            value = when (addPausedIndex) {
                                0 -> stringResource(Res.string.rss_rule_use_global_settings)
                                1 -> stringResource(Res.string.rss_rule_add_paused_always)
                                2 -> stringResource(Res.string.rss_rule_add_paused_never)
                                else -> ""
                            },
                            onValueChange = {},
                            readOnly = true,
                        ...
                        ExposedDropdownMenu(
                            ...
                            DropdownMenuItem(
                                text = { Text(text = stringResource(Res.string.rss_rule_use_global_settings)) },
                                onClick = {
                                    addPausedIndex = 0
                            ...
                            DropdownMenuItem(
                                text = { Text(text = stringResource(Res.string.rss_rule_add_paused_always)) },
                                onClick = {
                                    addPausedIndex = 1
                                    addPausedExpanded = false
                                },
                            ...
                            DropdownMenuItem(
                                text = { Text(text = stringResource(Res.string.rss_rule_add_paused_never)) },
                                onClick = {
                                    addPausedIndex = 2
                                    addPausedExpanded = false
                                },
                    ...
                    ExposedDropdownMenuBox(
                        ...
                        OutlinedTextField(
                            label = {
                                Text(
                                    text = stringResource(Res.string.rss_rule_torrent_content_layout),
                                    maxLines = 1,
                                    overflow = TextOverflow.Ellipsis,
                                )
                            },
                        ...
                        ExposedDropdownMenu(
                            ...
                            DropdownMenuItem(
                                text = { Text(text = stringResource(Res.string.torrent_add_content_layout_original)) },
                                onClick = {
                            ...
                            DropdownMenuItem(
                                text = { Text(text = stringResource(Res.string.torrent_add_content_layout_subfolder)) },
                                onClick = {
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(Res.string.rss_rule_apply_rule_to_feeds),
                    ...
                    Column(
                        ...
                        if (feeds?.isNotEmpty() == true) {
                            ...
                            Text(
                                text = stringResource(Res.string.rss_rule_no_feed_found),
